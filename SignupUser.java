...
public class SignupUser extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        emailField=(EditText)findViewById(R.id.useremail1);
        passwordField=(EditText)findViewById(R.id.userpassword1);
        repPasswordField =(EditText)findViewById(R.id.userre_password1);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            Intent i1 = new Intent(SignupUser.this,UserDetails.class);
                            i1.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(i1);
                        }
                        else {
                            Log.d(LOG_TAG, "Sign up fail "+ (task.getException().getMessage()));
                            Toast.makeText(SignupUser.this, "Authentication failed.",
