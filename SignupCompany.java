...
public class SignupCompany extends AppCompatActivity
{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        signup=(Button)findViewById(R.id.companysignupbutton);
        emailField=(EditText)findViewById(R.id.companyemail1);
        passwordField=(EditText)findViewById(R.id.companypassword1);
        repPasswordField =(EditText)findViewById(R.id.companyre_password1);
        userNameField =(EditText)findViewById(R.id.companyname);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful())
                        {
                            ...
                            Intent i1 = new Intent(SignupCompany.this,CompanyDetails.class);
    ...
    private void createUserInFirebaseHelper(String uid) {
        ...
        Log.d(LOG_TAG,"company");
        Company newCompany = new Company(userName, email);
        mDatabase.child("COMPANY").child(uid).setValue(newCompany);
